...
var walking_sound,attacking_sound;
...
function preload(){
  ...
  walking_sound = loadSound('walking.mp3');
  attacking_sound = loadSound('Attack_sound.mp3');
...
function draw() {
  ...
  if(gameState === 1){
    ...
    if(frameCount > 1780 && frameCount < 1800 ){
      fill("red");
      textSize(50);
      text("Level 2", 800, 200);
      }

    if(frameCount > 3780 && frameCount < 3800 ){
       fill("red");
       textSize(50);
       text("Level 3", 800, 200);
      }

    if(frameCount > 6280 && frameCount < 6300 ){
      fill("red");
      textSize(50);
      text("Level 4", 800, 200);
      }

    if(frameCount > 9280 && frameCount < 9300 ){
      fill("red");
      textSize(50);
